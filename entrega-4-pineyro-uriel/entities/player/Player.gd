...
func _handle_move_input():
	# Cambie la logica de movimiento porque con la version anterior, 
	# si ibas presionando en una dirección y cambiabas repentinamente a la otra,
	# el player se clavaba en el suelo
